...
var startGame = function() {
    ...
    for(var i = 0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
            ...
            // if we're alive and not at the last enemy in the array
    ...
    // after loop end, player is either out of health or enemies to fight, so run the endGame function
    endGame();
};
...
var shop = function() {
    ...
    switch(shopOptionPrompt) {
        ...
        default:
            ...
            // call shop() again to forece player to pick
            shop();
            break;
    }
};
